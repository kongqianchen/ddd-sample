...
@TableName("commodity")
public class CommodityMappingInfoDo {
    ...
    public static CommodityMappingInfoDo create(String json) { //泛型构造方法形参key的类型也为T，T的类型由外部指定
        return   JSONObject.parseObject(json, CommodityMappingInfoDo.class);
    }
