...
public class CommodityExtendConfig extends BaseEntity {
    ...
    public static CommodityExtendConfig create(String json) { //泛型构造方法形参key的类型也为T，T的类型由外部指定
        return JSONObject.parseObject(json, CommodityExtendConfig.class);
    }
